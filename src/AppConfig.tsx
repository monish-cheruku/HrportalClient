...
import imagearr from './Imageconst';
...
export const AppConfig = (props:any) => {
    ...
    const isOutsideClicked = (event: { target: any; }) => {
    ...
    const replaceLink = useCallback((linkElement: { setAttribute: (arg0: string, arg1: any) => void; getAttribute: (arg0: string) => any; cloneNode: (arg0: boolean) => any; parentNode: { insertBefore: (arg0: any, arg1: any) => void; }; nextSibling: any; remove: () => void; }, href: any, callback: () => void) => {
        if (isIE()) {
...
console.log(href)
            ...
            // cloneLinkElement.setAttribute('href', 'http://localhost:3000');
    ...
    useEffect(() => {
        let themeElement:any = document.getElementById('theme-link');
    ...
    const changeTheme = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>, theme: React.SetStateAction<string>, scheme: string) => {
