...
axios.defaults.baseURL = 'http://10.154.155.196:8000/api';
...
// const Bandapi={
//   getallbandsdata:()=>requests.get(`/Band`),
//   createband:(data)=>requests.post("/Band",data),
//   update:(data)=>requests.put("/Band",data)
// }
export  {quotes,companyapi, businessunitapi, Customerapi, Experienceapi, Designationapi, SubBandapi,servicelineapi,Locationapi,Bandapi,AvgCTCapi,insuranceapi, userrolesapi, AdUsersapi}